...
def main() -> int:
    ...
    require(
        ...
        (
            ...
            "BooleanSettingContracts.tplusStrokeFilter",
            "snapshot.tplusStrokeFilter.value",
    ...
    for localized_text, label in ((values, "English"), (values_zh, "Simplified Chinese")):
        require(
            ...
            (
                ...
                'name="modern_settings_tplus_stroke_filter_title"',
                'name="modern_settings_tplus_stroke_filter_summary"',
    ...
    require(
        ...
        (
            ...
            "tplusStrokeFilterPreservesExactKeyAndDefault",
    ...
    require(
        ...
        (
            ...
            "tplusStrokeFilter: BooleanSettingState",
